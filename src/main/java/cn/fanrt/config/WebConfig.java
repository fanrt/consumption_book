...
public class WebConfig extends WebMvcConfigurerAdapter {
  ...
  public VelocityConfigurer viewResolver() {
    ...
    velocityConfigurer.setResourceLoaderPath("/WEB-INF/views/,/WEB-INF/basesystemview/");
    velocityConfigurer.setConfigLocation(new ClassPathResource("velocity.properties"));
    Map map = new HashMap();
    map.put("velocimacro.library", "sysmacroLib.vm, macroLib.vm, workflowMacroLib.vm");
